        ...
        <>
            <Container className="lg:mx-0">
                ...
                <JobTable
                    ...
                    visibleColumns={['date', 'shop_date_scheduled', 'fab_type', 'fab_id', 'job_no', 'fab_info', 'no_of_pieces', 'total_sq_ft', 'wj_time_minutes', 'notes', 'final_programming_completed', 'final_programmer']}
                />
