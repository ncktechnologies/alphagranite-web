...
export function ResurfacingDetailsPage() {
        ...
        return (
            <Container className="border-t">
                <Alert variant="destructive">
                    ...
                    <AlertDescription>
                        Failed to load resurfacing details. {error && 'Please try again later.'}
                    </AlertDescription>
                </Alert>
            </Container>
        );
    ...
    return (
        <Container className="border-t">
            <Toolbar>
                <ToolbarHeading
                    title={`${fab.job_details?.name || 'Resurfacing'}`}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                <div className="lg:col-span-2">
                    <div className="flex justify-between items-center">
                        <div>
                            <h3 className="text-lg font-semibold">Resurfacing Details</h3>
                            <p className="text-sm text-muted-foreground">Current Stage: {fab.current_stage}</p>
                        </div>
                        <Link to={`/app/jobs/resurfacing`}>
