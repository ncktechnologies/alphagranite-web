...
export const TimeTrackingComponent = ({
  ...
  const confirmPause = async () => {
    ...
    try {
      ...
      toast.error('Failed to pause CNC session');
    }
  };
    ...
    <div className="border-none">
      ...
      <Dialog open={showPauseModal} onOpenChange={setShowPauseModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Pause CNC Session</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={showResumeModal} onOpenChange={setShowResumeModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Resume CNC Session</DialogTitle>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={showOnHoldModal} onOpenChange={setShowOnHoldModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Put CNC Session On Hold</DialogTitle>
          </DialogHeader>
          <div className="py-4 space-y-4">
            <div>
