...
import { useGetCNCSessionHistoryQuery } from '@/store/api/job';
...
export const SessionHistory = ({ fabId }: SessionHistoryProps) => {
    const { data: historyData, isLoading, error } = useGetCNCSessionHistoryQuery(fabId, {
        skip: !fabId,
    });
    ...
    return (
        <Card className="mt-4">
            <CardHeader>
                <CardTitle className="text-lg">CNC Session History</CardTitle>
                <p className="text-sm text-muted-foreground">Track your CNC session activities</p>
            </CardHeader>
            <CardContent>
