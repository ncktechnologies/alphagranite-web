        ...
        if (tableState.dateFilter && tableState.dateFilter !== 'all') {
            ...
            if (tableState.dateFilter === 'custom') {
                if (tableState.dateRange?.from) {
                    params.predraft_completed_start = tableState.dateRange.from.toISOString().split('T')[0];
                }
                if (tableState.dateRange?.to) {
                    params.predraft_completed_end = tableState.dateRange.to.toISOString().split('T')[0];
                }
