      ...
      toast.custom(
        () => (
          <Alert variant="success" icon="success">
            ...
            <AlertTitle>
              Wj scheduled successful <br />
              Your wj was updated successfully
            </AlertTitle>
          </Alert>
        ),
        {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6 pt-3">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder="WATERJET" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        <SelectItem value="WATERJET">WATERJET 1</SelectItem>
            ...
            <div className="flex justify-end gap-3 pt-4 ">
              ...
              >
                {isSubmitting ? "Scheduling..." : "Schedule for WJ"}
              </Button>
            </div>
          </form>
        </Form>
