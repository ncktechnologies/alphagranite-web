  ...
  const headerButton = () => {
    return (
      <Button
        variant="ghost"
        className={cn(
          'text-[#7C8689] leading-[15px] ultra:text-[15px] rounded-md font-normal h-full -ms-2 p-0  hover:bg-secondary/5 data-[state=open]:bg-secondary/5 hover:text-foreground data-[state=open]:text-foreground max-w-full text-left break-words whitespace-normal py-2',
          className,
        )}
