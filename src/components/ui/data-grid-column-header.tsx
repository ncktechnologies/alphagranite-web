  ...
  const headerButton = () => {
    return (
      <Button
        variant="ghost"
        className={cn(
          'text-foreground rounded-md font-normal -ms-2 px-2 h-7 hover:bg-muted data-[state=open]:bg-secondary hover:text-foreground data-[state=open]:text-foreground',
          className,
        )}
