...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Installation Template I', path: '/report/installation-template', permissionKey: 'installation_template' },
      { title: 'Installation Template II', path: '/report/template-card', permissionKey: 'installation_template' },
